...
https://github.com/tkscs/project-2-tell-a-robot-what-to-do-ThegreatThegreat14/pull/1

Overall Rough Draft Score: 50 / 50
 
Basic Functionality (15 points):

* [ 2 / 10 ] Robot can move, and code runs without errors in simulator
    * `Turn_Left`, `Turn_Right`, `Backward_Trick`, and `Forward_Trick` throw errors
* [ 4 / 5 ] Robot does not crash into walls
    * `Backward_Trick` allows the user to give amounts that make the robot crash into the wall
